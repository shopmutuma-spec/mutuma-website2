import { categories, products, loadStoreCatalog } from "./products.js?v=20260806e";
import { initCurrency } from "./currency.js?v=20260806e";
import { initBaseLayout, renderCategories, renderProductGrid } from "./ui.js?v=20260806e";
