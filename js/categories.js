import { categories, products, loadStoreCatalog } from "./products.js?v=20260915-geo";
import { initCurrency } from "./currency.js?v=20260915-geo";
import { initBaseLayout, renderCategories, renderProductGrid } from "./ui.js?v=20260915-geo";
