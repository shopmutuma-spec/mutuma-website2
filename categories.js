import { categories, products, loadStoreCatalog } from "./products.js?v=20260816a";
import { initCurrency } from "./currency.js?v=20260816a";
import { initBaseLayout, renderCategories, renderProductGrid } from "./ui.js?v=20260816a";
